        ...
        <div class=" pt-3 max-w-sm mx-auto px-4 sm:px-4 lg:px-8 ">
            <div class="bg-white overflow-hidden sm:rounded-lg  shadow-lg">
                ...
                <div class="px-2 py-5 sm:px-2 item">
                    ...
                    <input type="text" class="bg-gray-100 border border-gray-300 rounded-md pl-2 w-full" id="title" name="title" required>
                    </div>
                    <div class="mb-3">
                    <label class="mb-2  block" for="description">Description</label>
                    <input type="text" class="bg-gray-100 border border-gray-300 rounded-md pl-2  w-full" id="description"  name="description"  required>
                    </div> 
                    <div>
                    ...
                    <div>
                        ...
                        <input type="date" class="bg-gray-100 border border-gray-300 rounded-md pl-2 w-full mb-4" id="release_date" name="release_date"  required>
                    </div>
                    <div>
